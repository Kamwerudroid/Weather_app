...
function getWeatherByCoordinates(latitude, longitude) {
  getCityWeather('https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&appid=fb75a31cead1deab33795e78283aace0');
}
function getForecastByCoordinates(latitude, longitude) {
  getForecast(`https://api.openweathermap.org/data/3.0/onecall?lat={lat}&lon={lon}&appid=fb75a31cead1deab33795e78283aace0`);
}
